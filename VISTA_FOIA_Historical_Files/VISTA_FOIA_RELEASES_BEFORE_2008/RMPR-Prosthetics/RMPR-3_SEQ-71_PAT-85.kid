...
RMPR*3.0*85
"BLD",4884,0)
RMPR*3.0*85^PROSTHETICS^0^3040601^y
"BLD",4884,1,0)
^^2^2^3040325^
"BLD",4884,1,1,0)
...
RMPREOS^^0^B75513583
"BLD",4884,"KRN",9.8,"NM","B","RMPREOS",1)
...
"RTN","RMPREOS",2,0)
 ;;3.0;PROSTHETICS;**45,50,52,55,57,62,80,85**;Feb 09, 1996
"RTN","RMPREOS",3,0)
 ;
"RTN","RMPREOS",4,0)
