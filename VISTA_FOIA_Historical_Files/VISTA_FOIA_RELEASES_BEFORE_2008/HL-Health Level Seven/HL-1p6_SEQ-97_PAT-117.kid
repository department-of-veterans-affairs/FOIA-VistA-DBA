...
HL*1.6*117
"BLD",824,0)
HL*1.6*117^HEALTH LEVEL SEVEN^0^3040622^y
"BLD",824,1,0)
^^1^1^3040617^
"BLD",824,1,1,0)
...
"BLD",824,"KRN",9.8,0)
9.8
"BLD",824,"KRN",9.8,"NM",0)
^9.68A^2^2
"BLD",824,"KRN",9.8,"NM",1,0)
HLTP3^^0^B59405100
"BLD",824,"KRN",9.8,"NM",2,0)
HLTP4^^0^B32362883
"BLD",824,"KRN",9.8,"NM","B","HLTP3",1)

"BLD",824,"KRN",9.8,"NM","B","HLTP4",2)
...
"BLD",824,"KRN",101,0)
101
"BLD",824,"KRN",409.61,0)
409.61
"BLD",824,"KRN",771,0)
771
"BLD",824,"KRN",870,0)
870
"BLD",824,"KRN",8989.51,0)
8989.51
"BLD",824,"KRN",8989.52,0)
8989.52
"BLD",824,"KRN",8994,0)
8994
"BLD",824,"KRN","B",.4,.4)

"BLD",824,"KRN","B",.401,.401)

"BLD",824,"KRN","B",.402,.402)

"BLD",824,"KRN","B",.403,.403)

"BLD",824,"KRN","B",.5,.5)

"BLD",824,"KRN","B",.84,.84)

"BLD",824,"KRN","B",3.6,3.6)

"BLD",824,"KRN","B",3.8,3.8)

"BLD",824,"KRN","B",9.2,9.2)

"BLD",824,"KRN","B",9.8,9.8)

"BLD",824,"KRN","B",19,19)

"BLD",824,"KRN","B",19.1,19.1)

"BLD",824,"KRN","B",101,101)

"BLD",824,"KRN","B",409.61,409.61)

"BLD",824,"KRN","B",771,771)

"BLD",824,"KRN","B",870,870)

"BLD",824,"KRN","B",8989.51,8989.51)

"BLD",824,"KRN","B",8989.52,8989.52)

"BLD",824,"KRN","B",8994,8994)
...
0^1^B59405100
"RTN","HLTP3",1,0)
HLTP3 ;SFIRMFO/RSD - Transaction Processor for TCP ;06/10/2004  16:15
"RTN","HLTP3",2,0)
 ;;1.6;HEALTH LEVEL SEVEN;**19,43,57,58,59,66,69,109,115,108,116,117**;Oct 13, 1995
"RTN","HLTP3",3,0)
 ;
"RTN","HLTP3",4,0)
 Q
...
"RTN","HLTP3",42,0)
 . ; check sending apps and sending facilities
"RTN","HLTP3",43,0)
 . I $P(MSH(OIENS),HL("FS"),3)'=HL("SAN") S HLASTMSG=HLMTIENS Q
"RTN","HLTP3",44,0)
 . I $P(MSH(OIENS),HL("FS"),4)'=HL("SFN") S HLASTMSG=HLMTIENS Q
"RTN","HLTP3",45,0)
 . ; HL*1.6*117 end
"RTN","HLTP3",46,0)
...
0^2^B32362883
"RTN","HLTP4",1,0)
HLTP4 ;SFIRMFO/RSD - Transaction Processor for TCP ;06/10/2004  17:41
"RTN","HLTP4",2,0)
 ;;1.6;HEALTH LEVEL SEVEN;**19,57,59,91,109,116,117**;Oct 13, 1995
"RTN","HLTP4",3,0)
...
"RTN","HLTP4",35,0)
 ;
"RTN","HLTP4",36,0)
 I '$G(HLL("SET FOR APP ACK")) D  Q:'HLOGLINK
"RTN","HLTP4",37,0)
 .K HLL("LINKS")
"RTN","HLTP4",38,0)
 .I 'HLOGLINK D
