...
PSA*3.0*18
"BLD",765,0)
PSA*3.0*18^DRUG ACCOUNTABILITY^0^2990728^y
"BLD",765,1,0)
^^2^2^2990730^^^
"BLD",765,1,1,0)
...
"BLD",765,"KRN",.401,0)
.401
"BLD",765,"KRN",.401,"NM",0)
^9.68A^^0
"BLD",765,"KRN",.402,0)
.402
"BLD",765,"KRN",.402,"NM",0)
^9.68A^^0
"BLD",765,"KRN",.403,0)
.403
"BLD",765,"KRN",.5,0)
...
"BLD",765,"KRN",9.8,0)
9.8
"BLD",765,"KRN",9.8,"NM",0)
^9.68A^1^1
"BLD",765,"KRN",9.8,"NM",1,0)
PSATI^^0^B24015712
"BLD",765,"KRN",9.8,"NM","B","PSATI",1)
...
"BLD",765,"KRN","B",.401,.401)

"BLD",765,"KRN","B",.402,.402)

"BLD",765,"KRN","B",.403,.403)

"BLD",765,"KRN","B",.5,.5)

"BLD",765,"KRN","B",.84,.84)

"BLD",765,"KRN","B",3.6,3.6)

"BLD",765,"KRN","B",3.8,3.8)

"BLD",765,"KRN","B",9.2,9.2)

"BLD",765,"KRN","B",9.8,9.8)

"BLD",765,"KRN","B",19,19)

"BLD",765,"KRN","B",19.1,19.1)

"BLD",765,"KRN","B",101,101)

"BLD",765,"KRN","B",409.61,409.61)

"BLD",765,"KRN","B",771,771)

"BLD",765,"KRN","B",869.2,869.2)

"BLD",765,"KRN","B",870,870)

"BLD",765,"KRN","B",8994,8994)
...
"RTN","PSATI",2,0)
 ;;3.0; DRUG ACCOUNTABILITY/INVENTORY INTERFACE;**8,18**; 10/24/97
"RTN","PSATI",3,0)
...
"RTN","PSATI",43,0)
 S PSX="" F  S PSX=$O(PSANDF(PSA)) Q:PSA=""  D  Q:Y<1  D BINGO
"RTN","PSATI",44,0)
 .I PSA'["-" S PSA=$E(PSA,1,6)_"-"_$E(PSA,7,10)_"-"_$E(PSA,11,12)
"RTN","PSATI",45,0)
