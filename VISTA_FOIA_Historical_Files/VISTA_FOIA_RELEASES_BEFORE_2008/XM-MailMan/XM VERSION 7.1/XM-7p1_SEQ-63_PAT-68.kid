...
XMJMQ^^0^B66478526
"BLD",47,"KRN",9.8,"NM","B","XMAD1A",1)

"BLD",47,"KRN",9.8,"NM","B","XMJMQ",2)
...
0^1^B10458146
"RTN","XMAD1A",1,0)
XMAD1A ;(WASH ISC)/CAP-MailMan Deliver (3.9 File) ;10/16/98  13:27
"RTN","XMAD1A",2,0)
 ;;7.1;MailMan;**36,68**;Jun 02, 1994
"RTN","XMAD1A",3,0)
 ;
"RTN","XMAD1A",4,0)
...
0^2^B66478526
"RTN","XMJMQ",1,0)
XMJMQ ;ISC-SF/GMB- Q,QD,QN Query recipients ;10/16/98  15:41
"RTN","XMJMQ",2,0)
 ;;7.1;MailMan;**40,57,68**;Jun 02, 1994
"RTN","XMJMQ",3,0)
