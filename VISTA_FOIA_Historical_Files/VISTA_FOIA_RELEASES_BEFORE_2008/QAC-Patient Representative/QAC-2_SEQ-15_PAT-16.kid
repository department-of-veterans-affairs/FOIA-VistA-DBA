...
QAC*2.0*16
"BLD",2944,0)
QAC*2.0*16^PATIENT REPRESENTATIVE^0^3010626^y
"BLD",2944,4,0)
^9.64PA^^
"BLD",2944,"KRN",0)
^9.67PA^19^17
...
QACNEW^^0^B54462158
"BLD",2944,"KRN",9.8,"NM","B","QACNEW",1)
...
"RTN","QACNEW",2,0)
 ;;2.0;Patient Representative;**3,5,8,10,11,13,16**;07/25/1995
"RTN","QACNEW",3,0)
