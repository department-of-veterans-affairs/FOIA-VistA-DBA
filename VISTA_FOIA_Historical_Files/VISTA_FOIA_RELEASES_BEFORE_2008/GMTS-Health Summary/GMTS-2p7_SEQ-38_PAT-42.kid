...
GMTS*2.7*42
"BLD",2193,0)
GMTS*2.7*42^HEALTH SUMMARY^0^3001025^y
"BLD",2193,1,0)
^^2^2^3000918^
"BLD",2193,1,1,0)
...
"BLD",2193,"KRN",9.8,0)
9.8
"BLD",2193,"KRN",9.8,"NM",0)
^9.68A^1^1
"BLD",2193,"KRN",9.8,"NM",1,0)
GMTSONE^^0^B60038173
"BLD",2193,"KRN",9.8,"NM","B","GMTSONE",1)
...
"BLD",2193,"KRN","B",.401,.401)

"BLD",2193,"KRN","B",.402,.402)

"BLD",2193,"KRN","B",.403,.403)

"BLD",2193,"KRN","B",.5,.5)

"BLD",2193,"KRN","B",.84,.84)

"BLD",2193,"KRN","B",3.6,3.6)

"BLD",2193,"KRN","B",3.8,3.8)

"BLD",2193,"KRN","B",9.2,9.2)

"BLD",2193,"KRN","B",9.8,9.8)

"BLD",2193,"KRN","B",19,19)

"BLD",2193,"KRN","B",19.1,19.1)

"BLD",2193,"KRN","B",101,101)

"BLD",2193,"KRN","B",409.61,409.61)

"BLD",2193,"KRN","B",771,771)

"BLD",2193,"KRN","B",870,870)

"BLD",2193,"KRN","B",8994,8994)
...
"BLD",2193,"REQB",2,0)
GMTS*2.7*35^2
"BLD",2193,"REQB","B","GMTS*2.7*35",2)

"BLD",2193,"REQB","B","GMTS*2.7*36",1)
...
0^1^B60038173
"RTN","GMTSONE",1,0)
GMTSONE ; HIN/GWB - Oncology Health Summary Comp ; 09/18/2000
"RTN","GMTSONE",2,0)
 ;;2.7;Health Summary;**36,35,42**;Oct 20, 1995
"RTN","GMTSONE",3,0)
 ;
"RTN","GMTSONE",4,0)
...
"RTN","GMTSONE",6,0)
 ; DBIA 2924 access ^ONCO (file 160)
"RTN","GMTSONE",7,0)
 Q:'$D(^ONCO(160,"B",DFN_";DPT("))  S PTIEN=$O(^ONCO(160,"B",DFN_";DPT(",0))
"RTN","GMTSONE",8,0)
 S SUB="abcdefghijklmnopqrstuvwxyz",HSFLAG=1
"RTN","GMTSONE",9,0)
 ; DBIA 2888 access ^ONCO (file 165.5)
"RTN","GMTSONE",10,0)
 S IEN=0 F  S IEN=$O(^ONCO(165.5,"C",PTIEN,IEN)) Q:IEN=""  D
"RTN","GMTSONE",11,0)
 . ; DBIA 2888 access ^ONCO (file 165.5)
"RTN","GMTSONE",12,0)
 . S DIC="^ONCO(165.5,",DR=".04;3;20;22;24;29;30;37.1;37.2;37.3;38;85;86;87;88;58.1;58.3;58.2;50;51.2;51;442;125;127;128;53.2;53;54.2;54;55.2;55;346;560;91;58;75;76;77;2000;57;57.2;95"
"RTN","GMTSONE",13,0)
 . S DA=IEN D EN^DIQ1
"RTN","GMTSONE",14,0)
...
"RTN","GMTSONE",177,0)
 K ^UTILITY("DIQ1",$J)
"RTN","GMTSONE",178,0)
 K CNT,DA,DIC,DR,HSFLAG,IEN,LINE,LOS,NOP,ONC,PTIEN,SUB,SUBIEN,SUBCNT
"RTN","GMTSONE",179,0)
 K SUBLET,TSIEN,TXT,TXT1,TXT2
"RTN","GMTSONE",180,0)
 Q
"RTN","GMTSONE",181,0)
