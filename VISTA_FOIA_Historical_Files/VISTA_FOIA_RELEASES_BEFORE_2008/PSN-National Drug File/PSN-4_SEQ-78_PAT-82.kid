...
PSN*4.0*82
"BLD",4785,0)
PSN*4.0*82^NATIONAL DRUG FILE^0^3040316^y
"BLD",4785,1,0)
^^2^2^3040316^
"BLD",4785,1,1,0)
...
"BLD",4785,"KRN",9.8,0)
9.8
"BLD",4785,"KRN",9.8,"NM",0)
^9.68A^1^1
"BLD",4785,"KRN",9.8,"NM",1,0)
PSNOUT^^0^B10169547
"BLD",4785,"KRN",9.8,"NM","B","PSNOUT",1)
...
"BLD",4785,"KRN",101,0)
101
"BLD",4785,"KRN",409.61,0)
409.61
"BLD",4785,"KRN",771,0)
771
"BLD",4785,"KRN",870,0)
870
"BLD",4785,"KRN",8989.51,0)
8989.51
"BLD",4785,"KRN",8989.52,0)
8989.52
"BLD",4785,"KRN",8994,0)
8994
"BLD",4785,"KRN","B",.4,.4)

"BLD",4785,"KRN","B",.401,.401)

"BLD",4785,"KRN","B",.402,.402)

"BLD",4785,"KRN","B",.403,.403)

"BLD",4785,"KRN","B",.5,.5)

"BLD",4785,"KRN","B",.84,.84)

"BLD",4785,"KRN","B",3.6,3.6)

"BLD",4785,"KRN","B",3.8,3.8)

"BLD",4785,"KRN","B",9.2,9.2)

"BLD",4785,"KRN","B",9.8,9.8)

"BLD",4785,"KRN","B",19,19)

"BLD",4785,"KRN","B",19.1,19.1)

"BLD",4785,"KRN","B",101,101)

"BLD",4785,"KRN","B",409.61,409.61)

"BLD",4785,"KRN","B",771,771)

"BLD",4785,"KRN","B",870,870)

"BLD",4785,"KRN","B",8989.51,8989.51)

"BLD",4785,"KRN","B",8989.52,8989.52)

"BLD",4785,"KRN","B",8994,8994)
...
"RTN","PSNOUT",2,0)
 ;;4.0; NATIONAL DRUG FILE;**2,82**; 30 Oct 98
"RTN","PSNOUT",3,0)
INGRED ; output transform for ingredient
"RTN","PSNOUT",4,0)
 K X,LIST,^TMP($J,"PSNING") S K=PSNFNM,X=$$PSJING^PSNAPIS(,K,.LIST),STOP=X D ING0,ING00 F PSNXZ=0:0 S PSNXZ=$O(^TMP($J,"PSNING",PSNXZ)) Q:'PSNXZ  S INGT=^TMP($J,"PSNING",PSNXZ) D DISP,BREAK
"RTN","PSNOUT",5,0)
 K ^TMP($J,"PSNING")
"RTN","PSNOUT",6,0)
 Q
