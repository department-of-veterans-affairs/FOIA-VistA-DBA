...
ECX*3.0*27
"BLD",1654,0)
ECX*3.0*27^DSS EXTRACTS^0^2991109^y
"BLD",1654,4,0)
^9.64PA^^
"BLD",1654,"ABPKG")
n
...
"BLD",1654,"KRN",9.8,0)
9.8
"BLD",1654,"KRN",9.8,"NM",0)
^9.68A^3^3
"BLD",1654,"KRN",9.8,"NM",1,0)
ECXEC^^0^B18317799
"BLD",1654,"KRN",9.8,"NM",2,0)
ECXSCX1^^0^B43897019
"BLD",1654,"KRN",9.8,"NM",3,0)
ECXSCXN^^0^B59849882
"BLD",1654,"KRN",9.8,"NM","B","ECXEC",1)

"BLD",1654,"KRN",9.8,"NM","B","ECXSCX1",2)

"BLD",1654,"KRN",9.8,"NM","B","ECXSCXN",3)
...
"BLD",1654,"KRN",101,0)
101
"BLD",1654,"KRN",409.61,0)
409.61
"BLD",1654,"KRN",771,0)
771
"BLD",1654,"KRN",869.2,0)
869.2
"BLD",1654,"KRN",870,0)
870
"BLD",1654,"KRN",8994,0)
...
"BLD",1654,"KRN","B",.401,.401)

"BLD",1654,"KRN","B",.402,.402)

"BLD",1654,"KRN","B",.403,.403)

"BLD",1654,"KRN","B",.5,.5)

"BLD",1654,"KRN","B",.84,.84)

"BLD",1654,"KRN","B",3.6,3.6)

"BLD",1654,"KRN","B",3.8,3.8)

"BLD",1654,"KRN","B",9.2,9.2)

"BLD",1654,"KRN","B",9.8,9.8)

"BLD",1654,"KRN","B",19,19)

"BLD",1654,"KRN","B",19.1,19.1)

"BLD",1654,"KRN","B",101,101)

"BLD",1654,"KRN","B",409.61,409.61)

"BLD",1654,"KRN","B",771,771)

"BLD",1654,"KRN","B",869.2,869.2)

"BLD",1654,"KRN","B",870,870)

"BLD",1654,"KRN","B",8994,8994)
...
"RTN","ECXEC",2,0)
 ;;3.0;DSS EXTRACTS;**11,8,13,24,27**;Dec 22, 1997
"RTN","ECXEC",3,0)
...
"RTN","ECXEC",64,0)
 S ECXCMOD="" I $D(^ECH(ECDA,"MOD")) D
"RTN","ECXEC",65,0)
 .S MOD=0,M=""
"RTN","ECXEC",66,0)
 .F  S MOD=$O(^ECH(ECDA,"MOD",MOD)) Q:'MOD  S M=$P(^(MOD,0),U,1) I M S ECXCMOD=ECXCMOD_M_";"
"RTN","ECXEC",67,0)
 .K MOD,M
"RTN","ECXEC",68,0)
 S ECXCPT=$$CPT^ECXUTL3(ECPCE1,ECXCMOD)
"RTN","ECXEC",69,0)
...
"RTN","ECXSCX1",2,0)
 ;;3.0;DSS EXTRACTS;**8,28,24,27**;Dec 22, 1997
"RTN","ECXSCX1",3,0)
...
"RTN","ECXSCXN",2,0)
 ;;3.0;DSS EXTRACTS;**24,27**;Dec 22, 1997
"RTN","ECXSCXN",3,0)
 ;
"RTN","ECXSCXN",4,0)
BEG ;entry point from option
...
"RTN","ECXSCXN",51,0)
 ..S ECXKEY=ECXSTOP_"00003000000",ECXCLIN=""
"RTN","ECXSCXN",52,0)
 ..D FILE
"RTN","ECXSCXN",53,0)
 .;appointments
...
"RTN","ECXSCXN",66,0)
 ...S ECXKEY="10700003000000",ECXSTOP="107",ECXCLIN="" D FILE
"RTN","ECXSCXN",67,0)
 .;stop code additions
"RTN","ECXSCXN",68,0)
 .I PROCESS=2 D  Q
...
"RTN","ECXSCXN",161,0)
 .I $P(NODE,U,5) S ECXKEY="1070000300000N",ECXSTOP="107",ECXCLIN="" D FILE
"RTN","ECXSCXN",162,0)
 S ^TMP($J,"ECXP",ECXDFN)=""
"RTN","ECXSCXN",163,0)
 Q
