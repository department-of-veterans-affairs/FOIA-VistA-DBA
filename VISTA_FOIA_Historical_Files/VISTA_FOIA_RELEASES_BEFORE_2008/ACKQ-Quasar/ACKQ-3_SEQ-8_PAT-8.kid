...
ACKQUTL4^^0^B76816435
"BLD",4913,"KRN",9.8,"NM",2,0)
ACKQUTL8^^0^B44883529
"BLD",4913,"KRN",9.8,"NM",3,0)
ACKQASU^^0^B21284718
"BLD",4913,"KRN",9.8,"NM",4,0)
ACKQPCE1^^0^B70156756
"BLD",4913,"KRN",9.8,"NM",5,0)
ACKQNQ^^0^B22396694
"BLD",4913,"KRN",9.8,"NM",6,0)
ACKQUTL7^^0^B27034364
"BLD",4913,"KRN",9.8,"NM",7,0)
ACKQR3^^0^B77560321
"BLD",4913,"KRN",9.8,"NM",8,0)
ACKQR4^^0^B27747394
"BLD",4913,"KRN",9.8,"NM",9,0)
ACKQR2^^0^B80557034
"BLD",4913,"KRN",9.8,"NM",10,0)
ACKQUTL5^^0^B60056302
"BLD",4913,"KRN",9.8,"NM",11,0)
ACKQAS3^^0^B14261518
"BLD",4913,"KRN",9.8,"NM","B","ACKQAS3",11)

"BLD",4913,"KRN",9.8,"NM","B","ACKQASU",3)

"BLD",4913,"KRN",9.8,"NM","B","ACKQNQ",5)

"BLD",4913,"KRN",9.8,"NM","B","ACKQPCE1",4)

"BLD",4913,"KRN",9.8,"NM","B","ACKQR2",9)

"BLD",4913,"KRN",9.8,"NM","B","ACKQR3",7)

"BLD",4913,"KRN",9.8,"NM","B","ACKQR4",8)

"BLD",4913,"KRN",9.8,"NM","B","ACKQUTL4",1)

"BLD",4913,"KRN",9.8,"NM","B","ACKQUTL5",10)

"BLD",4913,"KRN",9.8,"NM","B","ACKQUTL7",6)

"BLD",4913,"KRN",9.8,"NM","B","ACKQUTL8",2)

"BLD",4913,"KRN",19,0)
19
"BLD",4913,"KRN",19,"NM",0)
^9.68A^1^1
"BLD",4913,"KRN",19,"NM",1,0)
ACKQAS UPDATE CPT MODIFIERS^^0
"BLD",4913,"KRN",19,"NM","B","ACKQAS UPDATE CPT MODIFIERS",1)
...
"BLD",4913,"REQB",2,0)
ACKQ*3.0*6^2
"BLD",4913,"REQB","B","ACKQ*3.0*5",1)

"BLD",4913,"REQB","B","ACKQ*3.0*6",2)

"KRN",19,10734,-1)
0^1
"KRN",19,10734,0)
ACKQAS UPDATE CPT MODIFIERS^Update CPT Modifiers per CO Directive^^E^^^^^^^^QUASAR^^1
"KRN",19,10734,1,0)
^19.06^15^15^3040227^^^^
"KRN",19,10734,1,1,0)
The system shall allows the user to select any Modifier already defined in
"KRN",19,10734,1,2,0)
the A&SP Modifier file for edit. The system allows selection of CPT
"KRN",19,10734,1,3,0)
Modifiers or a HCPCS Modifiers from the CPT Modifier File #81.3 that are
"KRN",19,10734,1,4,0)
defined as a type 'C' or type 'H'.
"KRN",19,10734,1,5,0)
The system prevents the user from adding to the A&SP Modifier File any
"KRN",19,10734,1,6,0)
Modifier that is defined as Inactive on the CPT Modifier File #81.3.
"KRN",19,10734,1,7,0)
The system also prevents the user from deleting a Modifier from the A&SP
"KRN",19,10734,1,8,0)
Modifier File.
"KRN",19,10734,1,9,0)
The system then prompts the user to enter the Status of the Modifier in
"KRN",19,10734,1,10,0)
QUASAR. Valid entries are '1' for Active or '0' for Inactive.
"KRN",19,10734,1,11,0)
If a new Modifier is selected from the CPT Modifier File the Modifier
"KRN",19,10734,1,12,0)
Status shall default to Active.
"KRN",19,10734,1,13,0)
If an existing Modifier is selected from the A&SP Modifier File then the
"KRN",19,10734,1,14,0)
system shall display the current status of the Modifier as the default
"KRN",19,10734,1,15,0)
value.
"KRN",19,10734,20)
S ACKLAYGO="",DLAYGO=509850.5 W @IOF,!,"This option allows you to enter new Procedure Modifiers or amend the status of  existing ones.",!
"KRN",19,10734,30)
ACK(509850.5,
"KRN",19,10734,31)
AEMQL
"KRN",19,10734,35)
W "",$$MODTXT^ACKQUTL8(Y,""),?48,$$GET1^DIQ(81.3,Y,.04)
"KRN",19,10734,50)
ACK(509850.5,
"KRN",19,10734,51)
[ACKQAS ENTER/EDIT MODIFIERS]
"KRN",19,10734,"U")
UPDATE CPT MODIFIERS PER CO DI
"MBREQ")
0
"ORD",18,19)
...
"RTN","ACKQPCE1",2,0)
 ;;3.0;QUASAR;**1,2,5,7,8**;Feb 11, 2000
"RTN","ACKQPCE1",3,0)
 ;
"RTN","ACKQPCE1",4,0)
