...
"BLD",776,"KRN",870,0)
870
"BLD",776,"KRN",8989.51,0)
8989.51
"BLD",776,"KRN",8989.52,0)
8989.52
"BLD",776,"KRN",8994,0)
8994
"BLD",776,"KRN","B",.4,.4)
...
"BLD",776,"KRN","B",8989.51,8989.51)

"BLD",776,"KRN","B",8989.52,8989.52)
...
0^1^B21522145
"RTN","XPAR",1,0)
XPAR ; SLC/KCM - Parameters File Calls ;08/26/2003  14:16
"RTN","XPAR",2,0)
 ;;7.3;TOOLKIT;**26,60,63,79**;Apr 25, 1995
"RTN","XPAR",3,0)
 ;
"RTN","XPAR",4,0)
...
"RTN","XPAR",121,0)
 . I FMT="B" S @ROOT@(@ROOT,"N")=EINST,LIST(LIST,"V")=VAL Q
"RTN","XPAR",122,0)
