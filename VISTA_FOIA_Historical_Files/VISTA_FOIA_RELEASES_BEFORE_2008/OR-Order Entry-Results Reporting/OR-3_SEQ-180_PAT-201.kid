...
OR*3.0*201
"BLD",4733,0)
OR*3.0*201^ORDER ENTRY/RESULTS REPORTING^0^3030904^y
"BLD",4733,1,0)
^^1^1^3021029^^^^
"BLD",4733,1,1,0)
...
"BLD",4733,4,101.24,0)
101.24
"BLD",4733,4,101.24,222)
n^n^f^^y^^y^r^n
"BLD",4733,4,101.24,224)
I $$SENDRPT^ORY201($P(^(0),U))
"BLD",4733,4,"B",101.24,101.24)
...
ORY201^^0^B224633
"BLD",4733,"KRN",9.8,"NM","B","ORY201",1)
