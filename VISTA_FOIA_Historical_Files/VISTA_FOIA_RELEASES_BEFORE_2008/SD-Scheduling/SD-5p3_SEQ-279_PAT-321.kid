EMERGENCY Released SD*5.3*321 SEQ #279
...
SD*5.3*321
"BLD",5124,0)
SD*5.3*321^SCHEDULING^0^3031022^y
"BLD",5124,1,0)
^^1^1^3031009^
"BLD",5124,1,1,0)
...
^9.68A^1^1
"BLD",5124,"KRN",9.8,"NM",1,0)
SCMSVUT1^^0^B58518412
"BLD",5124,"KRN",9.8,"NM","B","SCMSVUT1",1)
...
"RTN","SCMSVUT1",2,0)
 ;;5.3;Scheduling;**66,143,180,239,247,258,296,295,321**;AUG 13,1993
"RTN","SCMSVUT1",3,0)
