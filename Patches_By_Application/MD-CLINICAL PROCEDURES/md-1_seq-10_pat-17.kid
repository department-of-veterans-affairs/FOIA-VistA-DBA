...
MD*1.0*17
"BLD",6980,0)
MD*1.0*17^CLINICAL PROCEDURES^0^3080731^y
"BLD",6980,1,0)
^^2^2^3080520^
"BLD",6980,1,1,0)
...
MDRPCOR^^0^B87786828
"BLD",6980,"KRN",9.8,"NM","B","MDRPCOR",1)
...
MDPOST17
"IX",702,702,"AVPR",0)
702^AVPR^Trigger updates to VPR^MU^^R^^I^702^^^^^A
"IX",702,702,"AVPR",.1,0)
^^2^2^3050408^^^
"IX",702,702,"AVPR",.1,1,0)
This is an action index that updates the VPR
"IX",702,702,"AVPR",.1,2,0)
when the fields in this index are changed.
"IX",702,702,"AVPR",1)
I $T(UPD^VPRPROC)]"" D UPD^VPRPROC(X2(1),DA_";MDD(702,")
"IX",702,702,"AVPR",1.4)
S:X2(1)'="" X=1
"IX",702,702,"AVPR",2)
I $T(DEL^VPRPROC)]"" D DEL^VPRPROC(X1(1),DA_";MDD(702,")
"IX",702,702,"AVPR",2.4)
S:(X1(1)'=""&(X2(1)="")) X=1
"IX",702,702,"AVPR",11.1,0)
^.114IA^3^3
"IX",702,702,"AVPR",11.1,1,0)
1^F^702^.01^^^F
"IX",702,702,"AVPR",11.1,2,0)
2^F^702^.02^^^F
"IX",702,702,"AVPR",11.1,3,0)
3^F^702^.04^^^F
"MBREQ")
0
"PKG",365,-1)
...
"^DD",702,702,0,"ID",.04)
S %I=Y,Y=$S('$D(^(0)):"",$D(^MDS(702.01,+$P(^(0),U,4),0))#2:$P(^(0),U,1),1:""),C=$P(^DD(702.01,.01,0),U,2) D Y^DIQ:Y]"" W "   ",Y,@("$E("_DIC_"%I,0),0)") S Y=%I K %I
"^DD",702,702,0,"IX","ACON",702,.05)

"^DD",702,702,0,"IX","ACONV",702,.3)
...
"^DD",702,702,0,"IX","AS",702,.09)

"^DD",702,702,0,"IX","ASD",702,.14)

"^DD",702,702,0,"IX","ATIU",702,.06)

"^DD",702,702,0,"IX","AUPNV",702,.13)

"^DD",702,702,0,"IX","AVISIT",702,.13)

"^DD",702,702,0,"IX","B",702,.01)

"^DD",702,702,0,"NM","CP TRANSACTION")

"^DD",702,702,0,"PT",702.001,.01)

"^DD",702,702,0,"PT",703.1,.05)

"^DD",702,702,0,"PT",704.002,.07)

"^DD",702,702,0,"PT",704.202,.01)
