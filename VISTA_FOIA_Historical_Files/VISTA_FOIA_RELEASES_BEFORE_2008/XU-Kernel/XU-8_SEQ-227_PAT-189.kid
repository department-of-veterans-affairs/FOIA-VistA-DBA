...
XLFDT^^0^B25728732
"BLD",563,"KRN",9.8,"NM",2,0)
XLFDT1^^0^B5985780
"BLD",563,"KRN",9.8,"NM","B","XLFDT",1)

"BLD",563,"KRN",9.8,"NM","B","XLFDT1",2)
...
"BLD",563,"KRN",870,0)
870
"BLD",563,"KRN",8989.51,0)
8989.51
"BLD",563,"KRN",8989.52,0)
8989.52
"BLD",563,"KRN",8994,0)
8994
"BLD",563,"KRN","B",.4,.4)
...
"BLD",563,"KRN","B",8989.51,8989.51)

"BLD",563,"KRN","B",8989.52,8989.52)
...
0^1^B25728732
"RTN","XLFDT",1,0)
XLFDT ;ISC-SF/STAFF - Date/Time Functions ;12/02/2002  13:42
"RTN","XLFDT",2,0)
 ;;8.0;KERNEL;**71,120,166,168,179,189**;Jul 10, 1995
"RTN","XLFDT",3,0)
...
"RTN","XLFDT",66,0)
 Q (%V<1410102)!(%V>4141015)
"RTN","XLFDT",67,0)
HR(%V) ;Check $H in vlaid range
"RTN","XLFDT",68,0)
 Q (%V<2)!(%V>99999)
"RTN","XLFDT",69,0)
 ;
...
"RTN","XLFDT",84,0)
 N %TZ,%LTZ,%SN,%U,%H,%M Q:'$L(%P1) ""
"RTN","XLFDT",85,0)
 Q:($E(%P1,1,8)<18410102)!($E(%P1,1,8)>21141015) -1 ;Range Check
"RTN","XLFDT",86,0)
...
0^2^B5985780
"RTN","XLFDT1",1,0)
XLFDT1 ;ISC-SF/RWF - Date/Time Functions cont. from VA FileMan %DTC ;04/10/2002  17:29
"RTN","XLFDT1",2,0)
 ;;8.0;KERNEL;**71,189**;Jul 10, 1995
"RTN","XLFDT1",3,0)
...
F1 ;Apr 10, 2002
"RTN","XLFDT1",15,0)
 S %R=$P($T(M)," ",$S($E(Y,4,5):$E(Y,4,5)+2,1:0))_$S($E(Y,4,5):" ",1:"")_$S($E(Y,6,7):$E(Y,6,7)_", ",1:"")_($E(Y,1,3)+1700)
"RTN","XLFDT1",16,0)
 ;
"RTN","XLFDT1",17,0)
...
F8 ;10 Apr 02
"RTN","XLFDT1",51,0)
 S %R=$S($E(Y,6,7):$E(Y,6,7)_" ",1:"")_$P($T(M)," ",$S($E(Y,4,5):$E(Y,4,5)+2,1:0))_$S($E(Y,4,5):" ",1:"")_$E(Y,2,3)
"RTN","XLFDT1",52,0)
 G TM
"RTN","XLFDT1",53,0)
F9 ;10 Apr 2002
"RTN","XLFDT1",54,0)
 S %R=$S($E(Y,6,7):$E(Y,6,7)_" ",1:"")_$P($T(M)," ",$S($E(Y,4,5):$E(Y,4,5)+2,1:0))_$S($E(Y,4,5):" ",1:"")_($E(Y,1,3)+1700)
"RTN","XLFDT1",55,0)
 G TM
"VER")
8.0^22.0
