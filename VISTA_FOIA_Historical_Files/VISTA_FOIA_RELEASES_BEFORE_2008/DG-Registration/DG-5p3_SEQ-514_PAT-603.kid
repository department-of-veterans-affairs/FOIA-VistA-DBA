...
DG*5.3*603
"BLD",5127,0)
DG*5.3*603^REGISTRATION^0^3040521^y
"BLD",5127,4,0)
^9.64PA^^
"BLD",5127,"KRN",0)
^9.67PA^8989.52^19
...
DGMSRPT1^^0^B62478894
"BLD",5127,"KRN",9.8,"NM","B","DGMSRPT",1)

"BLD",5127,"KRN",9.8,"NM","B","DGMSRPT1",3)

"BLD",5127,"KRN",9.8,"NM","B","DGRPDT",2)
...
0^2^B62440669
"RTN","DGRPDT",1,0)
DGRPDT ;ALB/BRM - MILITARY SERVICE DATE UTILITIES ; 5/21/04 8:13am
"RTN","DGRPDT",2,0)
 ;;5.3;Registration;**562,603**;Aug 13, 1993
"RTN","DGRPDT",3,0)
 ;
...
"RTN","DGRPDT",164,0)
 I FRDT,(('$$B4(MSEFR,FRDT,1))!'$$B4(FRDT,MSETO)) Q "0^Conflict From Date is Not Within Military Service Episode Dates"
"RTN","DGRPDT",165,0)
 I TODT,(('$$B4(TODT,MSETO,1))!'$$B4(MSEFR,TODT)) Q "0^Conflict End Date is Not Within Military Service Episode Dates"
"RTN","DGRPDT",166,0)
 Q "1^OK"
"RTN","DGRPDT",167,0)
