EMERGENCY Released XM*7.1*102 SEQ #102
...
XM*7.1*102
"BLD",182,0)
XM*7.1*102^MAILMAN^0^2991006^y
"BLD",182,1,0)
^^55^55^2991006^^^^
"BLD",182,1,1,0)
Patch XM*7.1*102
...
XMAPHOST^^0^B37467106
"BLD",182,"KRN",9.8,"NM","B","XMAPHOST",1)
...
0^1^B37467106
"RTN","XMAPHOST",1,0)
XMAPHOST ;(WASH ISC)/KMB/CAP-Print to Message (P-MESSAGE) ;10/06/99  15:10
"RTN","XMAPHOST",2,0)
 ;;7.1;MailMan;**7,14,27,36,50,91,102**;Sep 12, 1994
"RTN","XMAPHOST",3,0)
 ;
"RTN","XMAPHOST",4,0)
