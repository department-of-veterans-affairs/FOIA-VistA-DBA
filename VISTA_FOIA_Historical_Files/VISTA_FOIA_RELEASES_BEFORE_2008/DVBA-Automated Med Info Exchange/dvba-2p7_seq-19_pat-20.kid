...
DVBA*2.7*20
"BLD",840,0)
DVBA*2.7*20^AUTOMATED MED INFO EXCHANGE^0^2980409^y
"BLD",840,1,0)
^^1^1^2980330^
"BLD",840,1,1,0)
DVBA*2.7*20
...
"BLD",840,"KRN",.4,"NM",0)
^9.68A^1^1
"BLD",840,"KRN",.4,"NM",1,0)
DVBA ADMISSION REVIEW    FILE #405^405^0
"BLD",840,"KRN",.4,"NM","B","DVBA ADMISSION REVIEW    FILE #405",1)
...
"BLD",840,"KRN",9.8,0)
9.8
"BLD",840,"KRN",9.8,"NM",0)
^9.68A^1^1
"BLD",840,"KRN",9.8,"NM",1,0)
DVBAREG2^^0^B32166669
"BLD",840,"KRN",9.8,"NM","B","DVBAREG2",1)
...
"BLD",840,"KRN","B",.401,.401)

"BLD",840,"KRN","B",.402,.402)

"BLD",840,"KRN","B",.403,.403)

"BLD",840,"KRN","B",.5,.5)

"BLD",840,"KRN","B",.84,.84)

"BLD",840,"KRN","B",3.6,3.6)

"BLD",840,"KRN","B",3.8,3.8)

"BLD",840,"KRN","B",9.2,9.2)

"BLD",840,"KRN","B",9.8,9.8)

"BLD",840,"KRN","B",19,19)

"BLD",840,"KRN","B",19.1,19.1)

"BLD",840,"KRN","B",101,101)

"BLD",840,"KRN","B",409.61,409.61)

"BLD",840,"KRN","B",771,771)

"BLD",840,"KRN","B",869.2,869.2)

"BLD",840,"KRN","B",870,870)

"BLD",840,"KRN","B",8994,8994)
...
"BLD",840,"REQB",1,0)
DVBA*2.7*17^2
"BLD",840,"REQB","B","DVBA*2.7*17",1)

"KRN",.4,796,-1)
0^1
"KRN",.4,796,0)
DVBA ADMISSION REVIEW^2980409.081^^405^^^2980409
"KRN",.4,796,"F",1)
-2,^DPT(^^S I(0,0)=D0 S DIP(1)=$S($D(^DGPM(D0,0)):^(0),1:"") S X=$P(DIP(1),U,3),X=X S D(0)=+X;Z;"PATIENT:"~-2,.01;L25~-2,.09;L12~-2,.314;"C-FOLD LOC";L6~
"KRN",.4,796,"F",2)
...
"RTN","DVBAREG2",2,0)
 ;;2.7;AMIE;**3,5,14,17,20**;Apr 10, 1995
"RTN","DVBAREG2",3,0)
 ;
"RTN","DVBAREG2",4,0)
