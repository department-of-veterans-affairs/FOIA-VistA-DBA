...
IVM*2.0*72
"BLD",4225,0)
IVM*2.0*72^INCOME VERIFICATION MATCH^0^3030625^y
"BLD",4225,4,0)
^9.64PA^^
"BLD",4225,"KRN",0)
^9.67PA^8989.52^19
...
"BLD",4225,"KRN",9.8,0)
9.8
"BLD",4225,"KRN",9.8,"NM",0)
^9.68A^1^1
"BLD",4225,"KRN",9.8,"NM",1,0)
IVMPREC1^^0^B42502600
"BLD",4225,"KRN",9.8,"NM","B","IVMPREC1",1)
...
0^1^B42502600
"RTN","IVMPREC1",1,0)
IVMPREC1 ;ALB/SEK/BRM - PROCESS INCOMING HL7 (ACK) MESSAGES ; 3/5/03 12:30pm
"RTN","IVMPREC1",2,0)
 ;;2.0;INCOME VERIFICATION MATCH;**9,17,26,52,34,72**; 21-OCT-94
"RTN","IVMPREC1",3,0)
...
"RTN","IVMPREC1",79,0)
 F IVMDA=0:0 S IVMDA=$O(^IVM(301.6,"AE",+IVMMCI,IVMDA)) Q:'IVMDA  I $$SETSTAT^IVMTLOG(IVMDA,1)
"RTN","IVMPREC1",80,0)
 Q
"RTN","IVMPREC1",81,0)
 ;
...
"RTN","IVMPREC1",141,0)
 N RET,IVMTEXT,I
"RTN","IVMPREC1",142,0)
 S RET=$$Z07CHK(IVMI,IVMMCI,IVMEM)
"RTN","IVMPREC1",143,0)
 Q:+RET +RET
"RTN","IVMPREC1",144,0)
 S XMSUB="HL7 ERROR CONDITION NOTIFICATION"
"RTN","IVMPREC1",145,0)
 S IVMTEXT(1)="An Acknowledgment to an IVM FULL DATA (Z07) HL7 Transmission is causing"
"RTN","IVMPREC1",146,0)
 S IVMTEXT(2)="an error condition to occur.  The cross reference (^IVM(301.6,""ADS""))"
"RTN","IVMPREC1",147,0)
 S IVMTEXT(3)="to match this acknowledgment to the original message is missing/undefined."
"RTN","IVMPREC1",148,0)
 S IVMTEXT(4)=""
"RTN","IVMPREC1",149,0)
 D:$P(RET,"^",2)'=""
"RTN","IVMPREC1",150,0)
 . S IVMTEXT(5)="The following condition was found to exist:"
"RTN","IVMPREC1",151,0)
 . S IVMTEXT(6)="      "_$P(RET,"^",2)
"RTN","IVMPREC1",152,0)
 . S IVMTEXT(7)="There is no immediate action needed by the site.  If there are a"
"RTN","IVMPREC1",153,0)
 . S IVMTEXT(8)="number of these messages being produced, a Remedy/NOIS Ticket should"
"RTN","IVMPREC1",154,0)
 . S IVMTEXT(9)="be entered to review the situation."
"RTN","IVMPREC1",155,0)
 D:$P(RET,"^",2)=""
"RTN","IVMPREC1",156,0)
 . S IVMTEXT(5)="A Remedy/NOIS Ticket should be entered to review this situation.  The problem"
"RTN","IVMPREC1",157,0)
 . S IVMTEXT(6)="ACK will be skipped by the Acknowledgment Processor to avoid any errors."
"RTN","IVMPREC1",158,0)
 S IVMTEXT(10)=""
"RTN","IVMPREC1",159,0)
 S IVMTEXT(11)="HL7 MESSAGE ADMINISTRATION (#773) Pointer: "_HLMTIENS
"RTN","IVMPREC1",160,0)
 S IVMTEXT(12)="Message Control ID: "_IVMMCI
"RTN","IVMPREC1",161,0)
 S IVMTEXT(13)=""
"RTN","IVMPREC1",162,0)
 D MAIL^IVMUFNC()
