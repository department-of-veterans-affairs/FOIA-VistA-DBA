...
MC*2.3*37
"BLD",3516,0)
MC*2.3*37^MEDICINE^0^3030403^y
"BLD",3516,1,0)
^^4^4^3030226^
"BLD",3516,1,1,0)
...
"BLD",3516,4,697.2,0)
697.2
"BLD",3516,4,697.2,2,0)
^9.641^697.2^1
"BLD",3516,4,697.2,2,697.2,0)
PROCEDURE/SUBSPECIALTY  (File-top level)
"BLD",3516,4,697.2,2,697.2,1,0)
^9.6411^14^1
"BLD",3516,4,697.2,2,697.2,1,14,0)
RNV STATUS ON
"BLD",3516,4,697.2,222)
y^n^p^^^^n
"BLD",3516,4,"APDD",697.2,697.2)

"BLD",3516,4,"APDD",697.2,697.2,14)

"BLD",3516,4,"B",697.2,697.2)
...
MCESEDT^^0^B30105892
"BLD",3516,"KRN",9.8,"NM","B","MCESEDT",1)
...
^9.49I^1^1
"PKG",171,22,1,0)
2.3^2960913^2970305^11714
"PKG",171,22,1,"PAH",1,0)
37^3030403
"PKG",171,22,1,"PAH",1,1,0)
^^4^4^3030403
"PKG",171,22,1,"PAH",1,1,1,0)
Fix to remove Released Not Verified (RNV) from list of choices for the 
"PKG",171,22,1,"PAH",1,1,2,0)
Release Status of a medical procedure when RNV STATUS ON field (#14)
"PKG",171,22,1,"PAH",1,1,3,0)
is set to "NO" in the PROCEDURE/SUBSPECIALTY file (#697.2) for that 
"PKG",171,22,1,"PAH",1,1,4,0)
procedure.
"QUES","XPF1",0)
Y
"QUES","XPF1","??")
...
8.0^22.0
"^DD",697.2,697.2,14,0)
RNV STATUS ON^S^0:NO;1:YES;^0;17^Q
"^DD",697.2,697.2,14,3)
Allows the manager to allow release not verified status
"^DD",697.2,697.2,14,21,0)
^^6^6^3030403^
"^DD",697.2,697.2,14,21,1,0)
This field allows the manager(s) to remove Release Not Verified as a
"^DD",697.2,697.2,14,21,2,0)
Status.  If the Manager answers "Yes" to RNV STATUS ON for a particular 
"^DD",697.2,697.2,14,21,3,0)
Procedure/Subspecialty, then users with the subspecialty provider key
"^DD",697.2,697.2,14,21,4,0)
can select Release Not Verified.  If the Manager answers "No" to RNV
"^DD",697.2,697.2,14,21,5,0)
STATUS ON, the key holder can only select a verified status and must sign
"^DD",697.2,697.2,14,21,6,0)
off on it.
"^DD",697.2,697.2,14,"DT")
3030403
**END**
**END**
