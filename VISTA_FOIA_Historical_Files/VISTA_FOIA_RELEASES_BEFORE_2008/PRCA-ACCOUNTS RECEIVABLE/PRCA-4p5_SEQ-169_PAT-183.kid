...
PRCA*4.5*183
"BLD",4118,0)
PRCA*4.5*183^ACCOUNTS RECEIVABLE^0^3030612^y
"BLD",4118,1,0)
^^1^1^3020619^
"BLD",4118,1,1,0)
...
"BLD",4118,"KRN",9.8,0)
9.8
"BLD",4118,"KRN",9.8,"NM",0)
^9.68A^1^1
"BLD",4118,"KRN",9.8,"NM",1,0)
PRCAHV^^0^B48852466
"BLD",4118,"KRN",9.8,"NM","B","PRCAHV",1)
...
"BLD",4118,"KRN",101,0)
101
"BLD",4118,"KRN",409.61,0)
409.61
"BLD",4118,"KRN",771,0)
771
"BLD",4118,"KRN",870,0)
870
"BLD",4118,"KRN",8989.51,0)
8989.51
"BLD",4118,"KRN",8989.52,0)
8989.52
"BLD",4118,"KRN",8994,0)
8994
"BLD",4118,"KRN","B",.4,.4)

"BLD",4118,"KRN","B",.401,.401)

"BLD",4118,"KRN","B",.402,.402)

"BLD",4118,"KRN","B",.403,.403)

"BLD",4118,"KRN","B",.5,.5)

"BLD",4118,"KRN","B",.84,.84)

"BLD",4118,"KRN","B",3.6,3.6)

"BLD",4118,"KRN","B",3.8,3.8)

"BLD",4118,"KRN","B",9.2,9.2)

"BLD",4118,"KRN","B",9.8,9.8)

"BLD",4118,"KRN","B",19,19)

"BLD",4118,"KRN","B",19.1,19.1)

"BLD",4118,"KRN","B",101,101)

"BLD",4118,"KRN","B",409.61,409.61)

"BLD",4118,"KRN","B",771,771)

"BLD",4118,"KRN","B",870,870)

"BLD",4118,"KRN","B",8989.51,8989.51)

"BLD",4118,"KRN","B",8989.52,8989.52)

"BLD",4118,"KRN","B",8994,8994)
...
"RTN","PRCAHV",2,0)
 ;;4.5;Accounts Receivable;**183**;Mar 20, 1995
"RTN","PRCAHV",3,0)
...
"RTN","PRCAHV",120,0)
 N X,Y,C,PRCADB,DEBT,TRAN,BILL,BAT,RCS,RCX,RCC,RCZ,RCY,RCDT
"RTN","PRCAHV",121,0)
 K RESULT
"RTN","PRCAHV",122,0)
 S X="ERROR^PRCAHV",@^%ZOSF("TRAP")
...
"RTN","PRCAHV",135,0)
 S (RCC,RCS)=0 F  S RCS=$O(^TMP("PRCAAPR",$J,"C",RCS)) Q:RCS<1  S RCX=0 F  S RCX=$O(^TMP("PRCAAPR",$J,"C",RCS,RCX))  Q:RCX<1  D
"RTN","PRCAHV",136,0)
...
"RTN","PRCAHV",139,0)
 . S RCDT=+$P(RCY,"^",10)
"RTN","PRCAHV",140,0)
 . S ^TMP("PRCAHV",$J,RCDT,RCX)=$G(^TMP("PRCAAPR",$J,"C",RCS,RCX))
"RTN","PRCAHV",141,0)
 . S $P(^TMP("PRCAHV",$J,RCDT,RCX),"^",10)=RCS ; 10(not 6)-because of reserved fields
"RTN","PRCAHV",142,0)
 K ^TMP("PRCAAPR",$J)
"RTN","PRCAHV",143,0)
 ;
"RTN","PRCAHV",144,0)
 S (RCC,RCDT)=0 F  S RCDT=$O(^TMP("PRCAHV",$J,RCDT)) Q:'RCDT  S RCX=0 F  S RCX=$O(^TMP("PRCAHV",$J,RCDT,RCX))  Q:'RCX  D
"RTN","PRCAHV",145,0)
 . N RCDESC
"RTN","PRCAHV",146,0)
 . D BILLDESC^RCCPCPS1(RCX)
"RTN","PRCAHV",147,0)
 . S RCB=0,RCZ=$G(^TMP("PRCAHV",$J,RCDT,RCX)),RCS=$P(RCZ,"^",10)
"RTN","PRCAHV",148,0)
