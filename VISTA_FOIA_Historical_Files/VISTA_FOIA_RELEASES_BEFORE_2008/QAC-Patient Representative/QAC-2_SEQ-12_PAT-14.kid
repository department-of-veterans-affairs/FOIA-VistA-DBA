...
QAC*2.0*14
"BLD",2479,0)
QAC*2.0*14^PATIENT REPRESENTATIVE^0^3001002^y
"BLD",2479,4,0)
^9.64PA^^
"BLD",2479,"ABNS",0)
^9.66A^1^1
...
"BLD",2479,"KRN",9.8,0)
9.8
"BLD",2479,"KRN",9.8,"NM",0)
^9.68A^2^2
"BLD",2479,"KRN",9.8,"NM",1,0)
QACMAIL0^^0^B22063642
"BLD",2479,"KRN",9.8,"NM",2,0)
QACMAIL1^^0^B50255381
"BLD",2479,"KRN",9.8,"NM","B","QACMAIL0",1)

"BLD",2479,"KRN",9.8,"NM","B","QACMAIL1",2)

"BLD",2479,"KRN",19,0)
19
"BLD",2479,"KRN",19,"NM",0)
^9.68A^^
"BLD",2479,"KRN",19.1,0)
19.1
"BLD",2479,"KRN",101,0)
101
"BLD",2479,"KRN",409.61,0)
409.61
"BLD",2479,"KRN",771,0)
771
"BLD",2479,"KRN",870,0)
...
"BLD",2479,"KRN","B",.401,.401)

"BLD",2479,"KRN","B",.402,.402)

"BLD",2479,"KRN","B",.403,.403)

"BLD",2479,"KRN","B",.5,.5)

"BLD",2479,"KRN","B",.84,.84)

"BLD",2479,"KRN","B",3.6,3.6)

"BLD",2479,"KRN","B",3.8,3.8)

"BLD",2479,"KRN","B",9.2,9.2)

"BLD",2479,"KRN","B",9.8,9.8)

"BLD",2479,"KRN","B",19,19)

"BLD",2479,"KRN","B",19.1,19.1)

"BLD",2479,"KRN","B",101,101)

"BLD",2479,"KRN","B",409.61,409.61)

"BLD",2479,"KRN","B",771,771)

"BLD",2479,"KRN","B",870,870)

"BLD",2479,"KRN","B",8994,8994)
...
"RTN","QACMAIL0",2,0)
 ;;2.0;Patient Representative;**4,14**;07/25/1995
"RTN","QACMAIL0",3,0)
 ;
"RTN","QACMAIL0",4,0)
 N QACQFLG
...
"RTN","QACMAIL0",13,0)
 S ZTDTH=QACSTART
"RTN","QACMAIL0",14,0)
 S ZTSAVE("XMTXT")="",ZTSAVE("QACNOT")="",ZTSAVE("QACQFLG")=""
"RTN","QACMAIL0",15,0)
 S ZTIO=""
"RTN","QACMAIL0",16,0)
...
"RTN","QACMAIL0",26,0)
 N QACERR,QACERROR,QACEXIT,QACINC,QACLIN,QANLINE,QACLSAT,QACMADE
"RTN","QACMAIL0",27,0)
...
"RTN","QACMAIL0",37,0)
 S QACINC="S QACTCNT=QACTCNT+$L($G(^TMP(""QAC MAIL"",$J,QACLCNT))),QACLCNT=QACLCNT+1"
"RTN","QACMAIL0",38,0)
 K ^TMP("QAC MAIL",$J)
"RTN","QACMAIL0",39,0)
 S QACEXIT=0
...
"RTN","QACMAIL0",44,0)
 ;reset ZTDTH, ^%ZTLOAD
"RTN","QACMAIL0",45,0)
 I $G(QACQFLG)<1 D ZTDTH ;re-tasks job for next run
"RTN","QACMAIL0",46,0)
 I $G(QACHK)=1 Q
"RTN","QACMAIL0",47,0)
 ;
...
"RTN","QACMAIL0",122,0)
 Q
"RTN","QACMAIL0",123,0)
REQUE ;this subroutine will task this extract once, for previous quarter.
"RTN","QACMAIL0",124,0)
 ;access is from programmer mode - to be used if extract not rec'd.
"RTN","QACMAIL0",125,0)
 N QACQFLG
"RTN","QACMAIL0",126,0)
...
"RTN","QACMAIL1",48,0)
 N QACCOM,QACDAT,QACDATE,QACDAYS,QACDISC,QACDIV,QACDOB,QACISSC,QACLSAT,QACPGV,QACPSRV,QACRDAT,QACRDATE,QACROC,QACSEAT,QACSEX,QACSSN,QACSTAT,QACTST
"RTN","QACMAIL1",49,0)
