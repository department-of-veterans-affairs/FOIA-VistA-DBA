EMERGENCY Released PRS*4*88 SEQ #80
...
"BLD",5235,"KRN",9.8,0)
9.8
"BLD",5235,"KRN",9.8,"NM",0)
^9.68A^1^1
"BLD",5235,"KRN",9.8,"NM",1,0)
PRS8HD^^0^B23104317
"BLD",5235,"KRN",9.8,"NM","B","PRS8HD",1)
...
"BLD",5235,"KRN",101,0)
101
"BLD",5235,"KRN",409.61,0)
409.61
"BLD",5235,"KRN",771,0)
771
"BLD",5235,"KRN",870,0)
870
"BLD",5235,"KRN",8989.51,0)
8989.51
"BLD",5235,"KRN",8989.52,0)
8989.52
"BLD",5235,"KRN",8994,0)
8994
"BLD",5235,"KRN","B",.4,.4)

"BLD",5235,"KRN","B",.401,.401)

"BLD",5235,"KRN","B",.402,.402)

"BLD",5235,"KRN","B",.403,.403)

"BLD",5235,"KRN","B",.5,.5)

"BLD",5235,"KRN","B",.84,.84)

"BLD",5235,"KRN","B",3.6,3.6)

"BLD",5235,"KRN","B",3.8,3.8)

"BLD",5235,"KRN","B",9.2,9.2)

"BLD",5235,"KRN","B",9.8,9.8)

"BLD",5235,"KRN","B",19,19)

"BLD",5235,"KRN","B",19.1,19.1)

"BLD",5235,"KRN","B",101,101)

"BLD",5235,"KRN","B",409.61,409.61)

"BLD",5235,"KRN","B",771,771)

"BLD",5235,"KRN","B",870,870)

"BLD",5235,"KRN","B",8989.51,8989.51)

"BLD",5235,"KRN","B",8989.52,8989.52)

"BLD",5235,"KRN","B",8994,8994)
...
0^1^B23104317
"RTN","PRS8HD",1,0)
PRS8HD ;HISC/MGD-DECOMPOSITION, DETERMINE HOLIDAYS ;11/25/2003
"RTN","PRS8HD",2,0)
 ;;4.0;PAID;**4,33,72,88**;Sep 21, 1995
"RTN","PRS8HD",3,0)
 ;
"RTN","PRS8HD",4,0)
...
"RTN","PRS8HD",19,0)
 ;
"RTN","PRS8HD",20,0)
 N CT,D,DD,DDQ,DN,DX,NY ;new variables used
"RTN","PRS8HD",21,0)
...
"RTN","PRS8HD",26,0)
 ;
"RTN","PRS8HD",27,0)
 ; The following code will need to be updated for years that have an
"RTN","PRS8HD",28,0)
 ; extra Christmas Holiday declared.
"RTN","PRS8HD",29,0)
 ;
"RTN","PRS8HD",30,0)
 ; Set the date range for the following If statement to the last holiday
"RTN","PRS8HD",31,0)
 ; of prior year and the date of the extra Christmas Holiday declared
"RTN","PRS8HD",32,0)
 ; for this year.
"RTN","PRS8HD",33,0)
 ;
"RTN","PRS8HD",34,0)
 I (X>3021225),(X'>3031226) D 
"RTN","PRS8HD",35,0)
 .S (CT,NY)=0,X1=$G(PRS8D(0)),X2="^K^P^M^I^L^C^V^T^X^E^N^" I X1]"",X2[("^"_X1_"^") S X1=$F(X2,X1)-1\2+1,J=$P($T(XHOL+(X1+6)),";;",2),H($P(J,"^",2),$P(J,"^",1))=$P(J,"^",3,5)
"RTN","PRS8HD",36,0)
 .E  F I=1:1 S J=$P($T(XHOL+(I+7)),";;",2) Q:J=""  S H($P(J,"^",2),$P(J,"^",1))=$P(J,"^",3,5) ;get dates by month
"RTN","PRS8HD",37,0)
 ;
"RTN","PRS8HD",38,0)
 ;This code handles all other years without an extra Christmas Holiday
"RTN","PRS8HD",39,0)
 E  D
"RTN","PRS8HD",40,0)
 .S (CT,NY)=0,X1=$G(PRS8D(0)),X2="^K^P^M^I^L^C^V^T^X^N^" I X1]"",X2[("^"_X1_"^") S X1=$F(X2,X1)-1\2+1,J=$P($T(H+(X1+6)),";;",2),H($P(J,"^",2),$P(J,"^",1))=$P(J,"^",3,5)
"RTN","PRS8HD",41,0)
 .E  F I=1:1 S J=$P($T(H+(I+7)),";;",2) Q:J=""  S H($P(J,"^",2),$P(J,"^",1))=$P(J,"^",3,5) ;get dates by month
"RTN","PRS8HD",42,0)
 ;
"RTN","PRS8HD",43,0)
...
"RTN","PRS8HD",116,0)
 ;    - E = Extra Christmas                              N = New Year's
"RTN","PRS8HD",117,0)
 ;
"RTN","PRS8HD",118,0)
...
"RTN","PRS8HD",122,0)
 ;
"RTN","PRS8HD",123,0)
XHOL ;--- Holidays for years with an extra Christmas Holiday
"RTN","PRS8HD",124,0)
 ;    PIECE1     PIECE2       PIECE3       PIECE4      PIECE5    PIECE6
"RTN","PRS8HD",125,0)
 ;    actual     month        exact day    0=exact     holiday   how
...
"RTN","PRS8HD",139,0)
 ;;Christmas Day^12^25^0^X^December 25
"RTN","PRS8HD",140,0)
 ;;Extra Christmas Day^12^26^0^E^December 26
"RTN","PRS8HD",141,0)
 ;;New Year's Day^1^1^0^N^January 1
"VER")
8.0^22
