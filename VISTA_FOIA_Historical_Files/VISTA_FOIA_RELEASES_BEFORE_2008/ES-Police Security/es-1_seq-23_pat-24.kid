...
ES*1.0*24
"BLD",919,0)
ES*1.0*24^POLICE & SECURITY^0^2980625^y
"BLD",919,1,0)
^^1^1^2980602^
"BLD",919,1,1,0)
...
"BLD",919,4,916,2,0)
^9.641^916^1
"BLD",919,4,916,2,916,0)
ESP DAILY JOURNAL  (File-top level)
"BLD",919,4,916,2,916,1,0)
^9.6411^2^1
"BLD",919,4,916,2,916,1,2,0)
TO
"BLD",919,4,916,222)
y^n^p^^^^n
"BLD",919,4,"APDD",916,916)

"BLD",919,4,"APDD",916,916,2)
...
"RTN","ESPAJE",2,0)
 ;;1.0;POLICE & SECURITY;**17,18,23,24**;Mar 31, 1994
"RTN","ESPAJE",3,0)
 ;
"RTN","ESPAJE",4,0)
