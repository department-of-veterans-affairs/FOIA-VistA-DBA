...
RG*0.5*3
"BLD",594,0)
RG*0.5*3^CLINICAL INFO RESOURCE NETWORK^0^^y
"BLD",594,1,0)
^^1^1^2990203^
"BLD",594,1,1,0)
...
"BLD",594,"KRN",9.8,0)
9.8
"BLD",594,"KRN",9.8,"NM",0)
^9.68A^3^3
"BLD",594,"KRN",9.8,"NM",1,0)
RGPRSSN^^0^B29982029
"BLD",594,"KRN",9.8,"NM",2,0)
RGVCCMR2^^0^B31191851
"BLD",594,"KRN",9.8,"NM",3,0)
RGVCCMR1^^0^B41285743
"BLD",594,"KRN",9.8,"NM","B","RGPRSSN",1)

"BLD",594,"KRN",9.8,"NM","B","RGVCCMR1",3)

"BLD",594,"KRN",9.8,"NM","B","RGVCCMR2",2)
...
"BLD",594,"KRN","B",.401,.401)

"BLD",594,"KRN","B",.402,.402)

"BLD",594,"KRN","B",.403,.403)

"BLD",594,"KRN","B",.5,.5)

"BLD",594,"KRN","B",.84,.84)

"BLD",594,"KRN","B",3.6,3.6)

"BLD",594,"KRN","B",3.8,3.8)

"BLD",594,"KRN","B",9.2,9.2)

"BLD",594,"KRN","B",9.8,9.8)

"BLD",594,"KRN","B",19,19)

"BLD",594,"KRN","B",19.1,19.1)

"BLD",594,"KRN","B",101,101)

"BLD",594,"KRN","B",409.61,409.61)

"BLD",594,"KRN","B",771,771)

"BLD",594,"KRN","B",869.2,869.2)

"BLD",594,"KRN","B",870,870)

"BLD",594,"KRN","B",8994,8994)
...
"BLD",594,"REQB",2,0)
FB*3.5*16^1
"BLD",594,"REQB","B","FB*3.5*16",2)

"BLD",594,"REQB","B","RG*0.5*2",1)
...
"RTN","RGPRSSN",2,0)
 ;;0.5; CLINICAL INFO RESOURCE NETWORK ;**1,3**;30 Sep 98
"RTN","RGPRSSN",3,0)
...
"RTN","RGVCCMR1",2,0)
 ;;0.5; CLINICAL INFO RESOURCE NETWORK ;**1,2,3**;30 Sep 98
"RTN","RGVCCMR1",3,0)
...
"RTN","RGVCCMR1",71,0)
 .S FILE=0
"RTN","RGVCCMR1",72,0)
 .S SCOREDT=$$FMTE^XLFDT($P(^DPT(RGDFN,"MPI"),U,7),"1P")
"RTN","RGVCCMR1",73,0)
